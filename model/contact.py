...
class Contact:
    ...
    def __init__(self, name=None, Middle=None, Last_name=None, Nickname=None, Title=None, Company=None,
                       Adress=None, Home_telephone=None, Mobile=None, year=None, adres_2=None, phone2=None, notes=None, id=None):
        self.name = name
        self.Middle = Middle
